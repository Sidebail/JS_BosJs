...
router.post('/gameview', function(req, res){
  ...
  player = new Player({ name: req.body.nickname, health: req.body.maxHealth, attack: req.body.attack , armor: req.body.armor, level: req.body.level, lastThreeEnemies: [enemy1, enemy2, enemy3]});
  player.save();
});
